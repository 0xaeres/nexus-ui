...
const cardVariants = cva('rounded-lg text-fg overflow-hidden', {
  variants: {
    variant: {
      ...
      stat: 'bg-surface border border-border relative before:absolute before:inset-0 before:pointer-events-none before:bg-[radial-gradient(circle_at_top_left,var(--tw-card-glow,var(--color-accent-soft)),transparent_60%)] shadow-card',
      ...
      glass: 'bg-surface-glass backdrop-blur-xl border border-white/[0.08] shadow-card-raised relative before:absolute before:inset-0 before:pointer-events-none before:bg-[radial-gradient(circle_at_top_left,var(--tw-card-glow,var(--color-accent-soft)),transparent_55%)]',
